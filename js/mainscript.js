...
function param_verify(i) {
  ...
  switch (param_num[calculatedIndex]) {
    ...
    case 606:
      ...
      break;
    case 604:
      document.getElementById("p604-box").value = getVal(i).toFixed(3);
      break;
    case 607:
      document.getElementById("p607-box").value = getVal(i).toFixed(3);
      break;
    case 697:
      document.getElementById("p697-box").value = getVal(i).toFixed(3);
      break;
    case 610:
...
function mqtt_parser(uartOutput) {
  const patterns = {
    ...
    mqttTLSLevel: /MQTT TLS Level:\s+(\d+)/,
...
async function processReceivedData() {
  ...
  if (
    ...
    if (hexToAscii(receiveBufferHex).includes("/P604")) {
      ...
      document.getElementById("p604-box").value = Number(hexToAscii(receiveBufferHex).slice(hexToAscii(receiveBufferHex).lastIndexOf(":") + 1));
      if (c_state == 3) {
    ...
    if (hexToAscii(receiveBufferHex).includes("/P607")) {
      ...
      document.getElementById("p607-box").value = Number(hexToAscii(receiveBufferHex).slice(hexToAscii(receiveBufferHex).lastIndexOf(":") + 1));
      if (c_state == 3) {
    ...
    if (hexToAscii(receiveBufferHex).includes("/P697")) {
      ...
      document.getElementById("p697-box").value = Number(hexToAscii(receiveBufferHex).slice(hexToAscii(receiveBufferHex).lastIndexOf(":") + 1));
      hideLoadingScreen_succesful();
    }
    if (
  ...
  if (
    ...
    if (string_check.includes("Entered PASSTHROUGH mode")) {
      ...
      if (string_check.includes("/P604")) {
        ...
        clearInterval(p_tid[`p604_tid`]);
        await delay(1000);
        document.getElementById("p604-box").value = Number(
          string_check
      ...
      if (string_check.includes("/P607")) {
        ...
        clearInterval(p_tid[`p607_tid`]);
        await delay(1000);
        document.getElementById("p607-box").value = Number(
          string_check
            .slice(string_check.lastIndexOf(":") + 1)
            .split("\r")[0]
            .trim()
      ...
      if (string_check.includes("/P697")) {
        ...
        clearInterval(p_tid[`p697_tid`]);
        await delay(1000);
        document.getElementById("p697-box").value = Number(
          string_check
            .slice(string_check.lastIndexOf(":") + 1)
            .split("\r")[0]
            .trim()
